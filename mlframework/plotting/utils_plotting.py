...
def create_axes_grid(
    ...
    mlframework.checks.all_same_type([n_columns, n_rows], int)
    mlframework.checks.all_same_type(
        [
            top,
            bottom,
            right,
    ...
    mlframework.checks.assert_same_type_as(skip_row_column, [[]])
    mlframework.checks.assert_same_type_as(colorbar_skip_row_col, [[]])
    mlframework.checks.assert_same_type_as(colorbar_include_row_columns, [[]])
    mlframework.checks.assert_shape(widths_along_x, (n_columns,), "widths_along_x")
    mlframework.checks.assert_shape(heights_along_y, (n_rows,), "heights_along_y")
...
def _plot_colorbar(
    plot, cax: mlframework.constants.TYPE_MATPLOTLIB_AXES | None = None
) -> mlframework.constants.TYPE_MATPLOTLIB_COLORBAR:
...
def plot_colorbar(
    ...
    cax: Optional[mlframework.constants.TYPE_MATPLOTLIB_AXES] = None,
    label: str | None = None,
    font_size: float = mlframework.constants.DEFAULT_FONTSIZE_SMALL,
) -> mlframework.constants.TYPE_MATPLOTLIB_COLORBAR:
