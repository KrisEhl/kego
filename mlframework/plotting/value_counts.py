...
def plot_value_counts(
    ...
    for column in df.columns:
        figure, axes, _ = mlframework.plotting.utils_plotting.create_axes_grid(
        ...
        if len(values) < 100:
            ...
            mlframework.plotting.histograms.plot_bar(
