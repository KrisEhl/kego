...
def _resolve_defaults(
    ...
    axes_style: mlframework.constants.AXES_STYLE_TYPE,
...
def _resolve_axes_style(
    axes: mlframework.constants.TYPE_MATPLOTLIB_AXES | None,
) -> mlframework.constants.AXES_STYLE_TYPE:
        ...
        for i_row in range(n_rows):
            for i_column in range(n_columns):
                if isinstance(facet_show_label_x, str):
                    ...
                    mlframework.checks.assert_all_same_type(facet_show_label_x, int)
        ...
        for i_row in range(n_rows):
            for i_column in range(n_columns):
                if isinstance(facet_show_label_y, str):
                    ...
                    mlframework.checks.assert_all_same_type(facet_show_label_y, int)
