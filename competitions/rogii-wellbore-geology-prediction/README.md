...
| v8b-postPS | LightGBM, v7 features, **post-PS-only training** | **15.58 ft** | folds 15.10/15.63/16.05/15.54. Filter verified in log (3.78M/5.09M rows). First result below constant via correct training setup. Gap to XGB Starter 15.01 = model family + feature count. |
