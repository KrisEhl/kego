...
| v17-catboost-div | CatBoost GPU on v15's **212 divergence features** | TBD | Ensemble prep: v14 catboost was on old 198 feat (10.81); re-run on best feature set for a stronger, diverse member of the planned NNLS blend (XGB+CB) — the reference's dominant lever (R6→R11). |
