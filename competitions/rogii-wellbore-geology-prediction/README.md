...
| v16-slopes | + **v4 slope features** (anchor_slope_k10/k25/k100, slope_accel_10_50/25_100; 217 cols) on top of divergence | TBD | Next v4 component (ref R10). Per-well anchor-tail TVT/MD slopes + accelerations via `robust_slope`. Debug smoke OK (+5 cols). Tests divergence+slopes vs v15's 10.48. |
