...
| v9-xgb | XGBoost, post-PS-only, slimmed df | **15.54 ft** | folds 15.43/15.20/15.99/15.52. Marginally beats LightGBM. **Slimming fix: 4–5 min/fold (was ~45 min)** — memory swap eliminated. Gap to XGB Starter 15.01 = feature count (36 vs 55). |
