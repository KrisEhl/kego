...
def get_models(
    ...
    all_models = {
        ...
        # === Optuna-tuned variants (from lgbm-tune-v2, 100 trials, 50K sample, ablation-pruned) ===
        # Best near-top trial with lr>=0.03 (OOF 0.9536 vs best 0.9537, ~3x faster training)
        "lightgbm_tuned": {
            "model": LGBMClassifier,
            "kwargs": {
                "n_estimators": 2000,
